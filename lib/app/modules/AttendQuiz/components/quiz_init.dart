...
import 'package:StaffFlow/app/modules/AttendQuiz/components/quiz_options.dart';
...
class QuizInit extends StatefulWidget {
  final int id;

  const QuizInit({Key key,  this.id}) : super(key: key);

  @override
  _QuizInitState createState() => _QuizInitState();
}

class _QuizInitState extends State<QuizInit> {
  @override
        ...
        children: [
          ...
          Padding(
            padding: EdgeInsets.only(
                top: 18.h, left: 32.w, right: 15.w, bottom: 29.h),
            child: Text(
